...
<div class="b-vacancies__item__name">Новый адрес</div>
<div class="b-vacancies__item__wrap">
	<div class="b-form">
		...
		<div class="clear"></div>
		<div class="btn btn_red new_address"">Сохранить</div>
		...
		<input type="hidden" id="path-to-component" value="<?=$componentPath."/dadata_address.php";?>"/>
	</div>
</div>
