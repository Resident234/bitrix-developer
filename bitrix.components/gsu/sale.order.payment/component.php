...
global $APPLICATION;
Asset::getInstance()->addCss("/local/components/peppers/sale.order.full/templates/.default/style.css");
// если перешли со страницы оформления заказа - скриптом отправим форму
if(!(strpos($_SERVER['HTTP_REFERER'],"/personal/order/")===false))
{
    Asset::getInstance()->addJs("/local/components/peppers/sale.order.payment/script.js");
}
